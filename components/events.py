class Events:
    ...
    def bind_all(self):
        ...
        # linux 
        # self.bind_to_editor_text("<Control-Button-4>", lambda *args: self.master.handle_zoom(1))
        # self.bind_to_editor_text("<Control-Button-5>", lambda *args: self.master.handle_zoom(-1))